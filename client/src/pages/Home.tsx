      ...
      <div className="max-w-2xl w-full relative z-10 transition-all duration-500">
        {!yesPressed ? (
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="w-full max-w-md aspect-video bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center overflow-hidden mb-8 relative"> <img src="/us.jpg" alt="Us" className="w-full h-full object-cover" /> </div>
